...
<p>Build repository-true, tiered verification maps for AGENTS.md.</p>
...
```text
帮我安装 agents-md-verification-map：https://raw.githubusercontent.com/Fable-Forge/agents-md-verification-map/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[agents-md-verification-map Issues](https://github.com/Fable-Forge/agents-md-verification-map/issues)
