# Install agents-md-verification-map
...
```text
安装 agents-md-verification-map：https://raw.githubusercontent.com/Fable-Forge/agents-md-verification-map/main/docs/install.md
```
...
从 `https://github.com/Fable-Forge/agents-md-verification-map` 安装 `agents-md-verification-map`，验证目标目录和 `SKILL.md`，并诚实报告哪些 Agent 已可发现。
...
| 运行时 | 目标目录 |
|---|---|
| Codex | `~/.codex/skills/agents-md-verification-map/` |
| Claude Code | `~/.claude/skills/agents-md-verification-map/` |
| Agent Skills | `~/.agents/skills/agents-md-verification-map/` |
